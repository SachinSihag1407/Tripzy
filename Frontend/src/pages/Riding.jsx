...
const Riding = () => {
    return (
        <div className='h-screen'>
            ...
            <Link to='/home' className='h-10 right-2 top-2 fixed w-10 bg-white flex items-center justify-center rounded-full'>
                    ...
                    <div className="w-full mt-5">
                        ...
                        <div className="flex items-center gap-5 p-3 border-b border-gray-300">
                            ...
                            <div>
                                ...
                                <p className="text-sm -mt-1 text-gray-600">Nabipura, Sikar</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-5 p-3">
                            ...
                            <div>
                                <h3 className="text-lg font-medium">194.45</h3>
