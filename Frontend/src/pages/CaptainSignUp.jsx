...
const CaptainSignUp = () => {
  ...
  const submitHandler = async (e) => {
    ...
    const response = await axiosInstance.post(`/captains/register`, captainData)
