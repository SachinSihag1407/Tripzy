...
const ConfirmRidePopUp = (props) => {
    ...
    return (
        ...
        <div>
            ...
            <div className='flex justify-between items-center bg-amber-400 rounded-lg p-3  mt-4'>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-6 w-full'>
                    ...
                    <form onSubmit={(e) => {
                        ...
                        <Link to='/captain-riding' className='w-full text-lg mt-5 flex justify-center bg-green-600 text-white font-semibold p-3 rounded-lg'>
                            Confirm
                        </Link>
                        ...
                        <button onClick={() => {
                            ...
                            className='w-full  text-lg mt-2 bg-red-500 text-white font-semibold p-3 rounded-lg'>
                            Cancle Ride
                        </button>
